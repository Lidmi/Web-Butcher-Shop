...
AddDescriptions(services, false);
OpenCloseDescription(products);
OpenCloseDescription(services);

function AddDescriptions(products, needImage) {
...
function OpenCloseDescription(products) {
    document.addEventListener('click', (e) => {
        let card;
        let path1; let path2; let path3;
        let description_container; let description;
        for (let i = 0; i < products.length; i++) {
